...
class ModeloVentasLoteria
{
    ...
    static public function mdlMostrarVentasAlVender($tabla1, $tabla2, $item, $valor)
    {
        ...
        $stmt = Conexion::conectar()->prepare(
            ...
            from $tabla1 v
            inner join $tabla2 n on v.idNumero = n.id
            WHERE $item = $valor AND v.idVendidoPor = $ses
            AND v.pasivo = 0
    ...
    static public function mdlMostrarVentasVendedor($tabla1, $tabla2, $item, $valor)
    {
        ...
        if ($item != null && $valor != null) {
            $stmt = Conexion::conectar()->prepare(
                ...
                i.inversion as inversion, i.premio as premio 
                from $tabla1 v
                inner join $tabla2 n on v.idNumero = n.id 
                WHERE v.$item = :$item
                AND v.pasivo = 0
    ...
    /*VER VENTAS NUM */
    static public function mdlMostrarVentasVendedorNum($tabla1, $tabla2, $item, $valor)
    {
        $ses = $_SESSION['idSesion'];
    ...
    /****************************************SUPERVISORES************************/
    /*VER VENTAS*/
    static public function mdlMostrarVentasSupervisor($tabla1, $tabla2, $tabla4)
    {
    ...
    /*VER VENTAS NUM */
    static public function mdlMostrarVentasSupervisorNum($tabla1, $tabla2, $tabla4)
    {
        if (isset($_SESSION["idSesion"])) {
            $usuarioIngreso = ControladorUsuarios::ctrMostrarUsuarios("id", $_SESSION["idSesion"]);
        }
    ...
    /****************************************Administradores************************/
    /*VER VENTAS*/
    static public function mdlMostrarVentasAdministrador($tabla1, $tabla2, $tabla4)
    {
        $stmt = Conexion::conectar()->prepare(
            "SELECT
                v.id as id, v.inversion as inversion,
    ...
    /*VER VENTAS NUM */
    static public function mdlMostrarVentasAdministradorNum($tabla1, $tabla2, $tabla4)
    {
        $stmt = Conexion::conectar()->prepare(
            "SELECT
                count(v.id) as boletos,
    ...
    {
        $stmt = Conexion::conectar()->prepare(
            "INSERT INTO $tabla(idNumero, inversion, premio, idVendidoPor, codigo)
            VALUES (:idNumero, :inversion, :premio, :idVendidoPor, :codigo)"
        );
    ...
    static public function mdlRegistroRecibos($recibos, $suma, $codigo, $cantidadNumeros, $vende)
    {

        $stmt = Conexion::conectar()->prepare(
            "INSERT INTO $recibos(codigo, cantidadNumeros, monto, idVendidoPor)
            VALUES (:codigo, :cantidadNumeros, :monto, :idVendidoPor)"
        );
    ...
    static public function mdlEliminarVentas($codigo)
    {

        $stmt = Conexion::conectar()->prepare(
            "UPDATE ventas_loteria SET pasivo = 1
            WHERE codigo = '$codigo'"
        );
        $stmt->bindParam(':codigo', $codigo, PDO::PARAM_STR);
        ...
        $stmt2 = Conexion::conectar()->prepare(
            "UPDATE recibos_loteria SET pasivo = 1
            WHERE codigo = '$codigo'"
        );
    ...
    static public function mdlMostrarListaVendedeoresSupervisor($tabla1, $tabla2)
    {
        if (isset($_SESSION["idSesion"])) {
            $usuarioIngreso = ControladorUsuarios::ctrMostrarUsuarios("id", $_SESSION["idSesion"]);
        }
    ...
    static public function mdlMostrarListaVendedeoresAdministrador($tabla1, $tabla2)
    {
        $stmt = Conexion::conectar()->prepare(
            "SELECT sum(v.inversion) as sumatoria,
            count(distinct(v.codigo)) as boletos,
    ...
    static public function mdlMostrarVentasGanador($tabla1, $tabla2, $item, $valor)
    {
        $stmt = Conexion::conectar()->prepare(
    ...
    static public function mdlMostrarVentasNoDetalle($tabla1, $tabla2, $tabla4, $item, $valor)
    {
        $stmt = Conexion::conectar()->prepare(
            "SELECT
            u.nombre as nombre,
