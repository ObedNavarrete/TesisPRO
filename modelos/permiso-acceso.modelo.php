...
class ModeloPermisoAcceso
{
    static public function mdlMostrarUsuariosParaAcceso()
    {
    ...
    static public function mdlActualizarAcceso($valor1, $valor2)
    {

        $stmt = Conexion::conectar()->prepare("UPDATE usuarios SET acceso = :$valor2 WHERE id = :$valor1");
