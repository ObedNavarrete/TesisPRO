$(document).ready(function () {
  $(".tablaListaVentasVendedor thead tr")
    .clone(true)
    .addClass("filters")
    .appendTo(".tablaListaVentasVendedor thead");

  var table = $(".tablaListaVentasVendedor").DataTable({
    deferRender: true,
    searching: true,
    retrieve: true,
    procesing: true,
    ...
    buttons: [
      ...
      },
      {
        ...
        messageTop: "Consolidado de Ventas por Vendedor en el Sorteo Actual",
        title: "RIFA DÍAZ",
        exportOptions: {
          columns: [0, 1, 2, 3],
        },
        customize: function (doc) {
          ...
          doc.content[2].table.widths = ["35%", "25%", "25%", "15%"];
