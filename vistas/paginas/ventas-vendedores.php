...
if ($usuarioIngreso['rol'] == 'Supervisor') {
    $ventas = ControladorVentas::ctrMostrarListaVendedeoresSupervisor();
} else if ($usuarioIngreso['rol'] == 'Super') {
    $ventas = ControladorVentas::ctrMostrarListaVendedeoresAdministrador();
}
    ...
    <div class="card mx-1 mx-lg-2">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table container-fluid tablaListaVentasVendedor mx-0 display" width="100%">
