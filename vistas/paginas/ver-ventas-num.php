...
if ($usuarioIngreso['rol'] == 'Editor') {
    $ventasNum = ControladorVentas::ctrMostrarVentasVendedorNum(null, null);
} else if ($usuarioIngreso['rol'] == 'Supervisor') {
    $ventasNum = ControladorVentas::ctrMostrarVentasSupervisorNum();
} else if ($usuarioIngreso['rol'] == 'Super') {
    $ventasNum = ControladorVentas::ctrMostrarVentasAdministradorNum();
}
    ...
    <div class="container-fluid">
        <div class="row mb-2 ml-2">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Ventas Números</li>
            </ol>
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="card mx-1 mx-lg-2">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table container-fluid mx-0 display tablaVentasNum" width="100%">
...
<div class="modal fade mt-5" id="verNum" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog container modal-xl">
      ...
      <h5 class="pl-2">Boleto no: <span class="text-success"><?php echo $recibo ?></span> </h5> -->
            <div class="card-body">
                ...
                <div class="row border-bottom">
                    <p class="text-center col-4 font-weight-bolder">Vende</p>
                    <p class="text-center col-3 font-weight-bolder">Recibo</p>
                    <p class="text-center col-2 font-weight-bolder">Monto</p>
