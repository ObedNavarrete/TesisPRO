<?php
require('fpdf.php');
require_once "/home/customer/www/rifadiaz.net/public_html/controladores/recibos.controlador.php";
require_once "/home/customer/www/rifadiaz.net/public_html/modelos/recibos.modelo.php";

$codigo = $_GET['codigo'];

$detalle = ControladorRecibos::ctrMostrarREC($codigo);
